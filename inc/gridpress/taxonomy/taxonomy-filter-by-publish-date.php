<?php
	...
	<?php $month_heading_count++; $month_count++; $taxonomy_unit_count++; endforeach; ?>
	<?php endforeach; ?>
	<?php else: ?>
		<p class="taxonomy--empty">No <?php echo $post_type_slug; ?> entries in the month of <?php echo ucfirst(date('F', strtotime($query_vars_month))); ?></p>
	<?php endif; ?>
	<?php
		wp_reset_postdata();
